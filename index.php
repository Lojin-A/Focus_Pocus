    ...
    <div class="card <?= $top_game === 'Whack-a-Mole' ? 'most-liked' : '' ?>">
        ...
        <div class="content">
            <div class="icon-container">
                ...
                <button class="like-btn <?= in_array('Whack-a-Mole', $user_liked) ? 'liked' : '' ?>"
                        data-game="Whack-a-Mole"
                        data-liked="<?= in_array('Whack-a-Mole', $user_liked) ? '1' : '0' ?>">
                    <i class="fa-solid fa-heart"></i>
                    <span class="count"><?= $likes['Whack-a-Mole'] ?? 0 ?></span>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="card <?= $top_game === 'Memory Match' ? 'most-liked' : '' ?>">
        ...
        <div class="content">
            <div class="icon-container">
                ...
                <button class="like-btn <?= in_array('Memory Match', $user_liked) ? 'liked' : '' ?>"
                        data-game="Memory Match"
                        data-liked="<?= in_array('Memory Match', $user_liked) ? '1' : '0' ?>">
                    <i class="fa-solid fa-heart"></i>
                    <span class="count"><?= $likes['Memory Match'] ?? 0 ?></span>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="card <?= $top_game === 'Rock Paper Scissors' ? 'most-liked' : '' ?>">
        ...
        <div class="content">
            <div class="icon-container">
                ...
                <button class="like-btn <?= in_array('Rock Paper Scissors', $user_liked) ? 'liked' : '' ?>"
                        data-game="Rock Paper Scissors"
                        data-liked="<?= in_array('Rock Paper Scissors', $user_liked) ? '1' : '0' ?>">
                    <i class="fa-solid fa-heart"></i>
                    <span class="count"><?= $likes['Rock Paper Scissors'] ?? 0 ?></span>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="card <?= $top_game === 'Guess the Number' ? 'most-liked' : '' ?>">
        ...
        <div class="content">
            <div class="icon-container">
                ...
                <button class="like-btn <?= in_array('Guess the Number', $user_liked) ? 'liked' : '' ?>"
                        data-game="Guess the Number"
                        data-liked="<?= in_array('Guess the Number', $user_liked) ? '1' : '0' ?>">
                    <i class="fa-solid fa-heart"></i>
                    <span class="count"><?= $likes['Guess the Number'] ?? 0 ?></span>
                </button>
            </div>
        </div>
    </div>
